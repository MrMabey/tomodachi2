// Alien Avatar Renderer - Cosmic Being with Space Effects
class AlienAvatar {
  constructor(size = 64) {
    ...
    // Alien colors - cosmic/space palette
    this.colors = {
  ...
  updateTimers(timestamp) {
    this.blinkTimer = (timestamp / 1000) % 6; // Slow, alien-like blinks
...
window.AlienAvatar = AlienAvatar;
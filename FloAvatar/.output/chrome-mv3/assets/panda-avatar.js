// Panda Avatar Renderer - Cute Panda with Bamboo Theme
class PandaAvatar {
  constructor(size = 64) {
    ...
    // Panda colors - natural/zen palette
    this.colors = {
  ...
  updateTimers(timestamp) {
    this.blinkTimer = (timestamp / 1000) % 4; // Relaxed blinking
...
window.PandaAvatar = PandaAvatar;
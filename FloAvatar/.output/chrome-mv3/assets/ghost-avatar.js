// Ghost Avatar Renderer - Ethereal Spirit with Mystical Effects
class GhostAvatar {
  constructor(size = 64) {
    ...
    // Ghost colors - ethereal/mystical palette
    this.colors = {
  ...
  updateTimers(timestamp) {
    this.blinkTimer = (timestamp / 1000) % 5; // Slower, more mysterious blinks
  ...
  drawWisps() {
    ...
    [
      ...
      const wispGradient = ctx.createRadialGradient(wisp.x, wisp.y, 0, wisp.x, wisp.y, wisp.size * 2);

// Dragon Avatar Renderer - Fierce Dragon with Fire Effects
class DragonAvatar {
  constructor(size = 64) {
  ...
  updateTimers(timestamp) {
    this.blinkTimer = (timestamp / 1000) % 4; // Slower blink for dragon
    this.wingFlapTimer = (timestamp / 500) % (Math.PI * 2); // Wing flapping
    this.breathingTimer = (timestamp / 3000) % (Math.PI * 2); // Deeper breathing
